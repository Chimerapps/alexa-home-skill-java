 ...
 * Date 10/03/2017.
 */
public class SetTargetTemperatureRequest extends ApplianceRequest {

	private final Value targetTemperature;

	@JsonCreator
	public SetTargetTemperatureRequest(@JsonProperty("accessToken") final String accessToken,
	                                   @JsonProperty("appliance") final Appliance appliance,
	                                   @JsonProperty("targetTemperature") final Value targetTemperature) {
