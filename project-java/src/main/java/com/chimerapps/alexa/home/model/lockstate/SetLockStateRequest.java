...
package com.chimerapps.alexa.home.model.lockstate;
 ...
 * @date 10/03/2017.
 */
public class SetLockStateRequest extends ApplianceRequest {

	private final String lockState;

	@JsonCreator
	public SetLockStateRequest(@JsonProperty("accessToken") final String accessToken,
	                           @JsonProperty("appliance") final Appliance appliance,
	                           @JsonProperty("lockState") final String lockState) {
