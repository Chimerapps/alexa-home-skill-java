 ...
 * @date 10/03/2017.
 */
public class DecrementTargetTemperatureRequest extends ApplianceRequest {

	private final Value deltaTemperature;

	@JsonCreator
	public DecrementTargetTemperatureRequest(@JsonProperty("accessToken") final String accessToken,
