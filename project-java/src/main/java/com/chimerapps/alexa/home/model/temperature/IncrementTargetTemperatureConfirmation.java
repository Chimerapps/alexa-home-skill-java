 ...
 * @date 10/03/2017.
 */
public class IncrementTargetTemperatureConfirmation extends ResponsePayload {
	...
	public IncrementTargetTemperatureConfirmation(final PreviousTemperature previousState,
	                                              final Value targetTemperature,
	                                              final TemperatureMode temperatureMode) {
		super("IncrementTargetTemperatureConfirmation");
