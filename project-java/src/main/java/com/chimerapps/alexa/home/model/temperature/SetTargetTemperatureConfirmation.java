 ...
 *         Date 10/03/2017.
 */
public class SetTargetTemperatureConfirmation extends ResponsePayload {
	...
	public SetTargetTemperatureConfirmation(final PreviousTemperature previousState,
	                                        final Value targetTemperature,
	                                        final TemperatureMode temperatureMode) {
		super("SetTargetTemperatureConfirmation");
